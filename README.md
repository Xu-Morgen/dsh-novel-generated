...
- 权威开发计划：`docs/novel-creation-tool-development-plan.md`（v3.1；I1–I140 已完成，当前执行 I141，Stage 19–21 排期至 I161）
...
> **交付状态**：I1–I140 已完成，以上 12 步主流程、细纲范围生成、统一定稿、全书完成门、单文件合稿和作者流程界面均已交付。当前执行 I141；Stage 19 / I141–I149 先增强来源确认、幕后素材 POV 叙事化与 C3/C4 安全边界，Stage 20 / I150–I154 重构导入地基，Stage 21 / I155–I161 才交付已有正文保真导入。在对应阶段完成前不得把新增分支表述为已经可用。

### 完整产品级测试流程

| 步骤 | 必须观察到的作者结果 | 主要迭代证据 |
| --- | --- | --- |
| 1–2 解释来源并确认大纲 | 已交付思路/梗概/长稿拆纲；Stage 19 新增来源确认、幕后 POV 叙事化与安全揭示，Stage 21 再新增已有正文保真进入 C5；候选确认前零写，非空作品不被静默覆盖 | I37–I38、I50–I53、I119–I120；增强 I141–I149、I155–I161 |
...
- I1–I140 已交付完整 12 步主流程；Stage 19 / I141–I149 只新增来源确认、幕后素材叙事化和 C3/C4 安全边界，完成前现有导入仍可能把混合幕后资料按普通长稿拆纲。Stage 21 / I155–I161 完成前，已有正文仍只能拆纲或手工录入，不能保真进入 C5。
