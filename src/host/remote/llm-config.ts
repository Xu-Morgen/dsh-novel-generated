...
function llmConfigInvocation(method: string, parameters: readonly InvocationParameterDescriptor[], resultSchema: TypertCodec): InvocationDescriptor {
  return { id: `novel-creation-tool/novelLlmConfig/${method}`, service: 'novelLlmConfig', namespace: 'novelLlmConfig', method, invocation: { kind: 'direct' }, parameters, result: resultSchema };
}
...
export const llmConfigRemoteContribution: TypertRemoteContribution = { package: 'novel-creation-tool-llm-config', descriptors: [...llmConfigInvocations] };
