...
/** I130：版本树由 Host 唯一聚合；Client 不以 chapterList + N×list 重建投影。 */
export function branchAggregateWireAdapter(
  service: Pick<NovelBranchService, 'aggregate'>,
  projectId: string,
) {
  return service.aggregate(projectId);
}
