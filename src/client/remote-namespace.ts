...
export type WorkspaceNamespace = NamespaceOf<typeof workspaceRemoteContribution> & import('../app/outline-description-contract.js').OutlineDescriptionNamespace & import('../app/draft-card-progress-contract.js').DraftCardProgressNamespace & import('../app/chapter-finalization-contract.js').ChapterFinalizationNamespace & import('../app/character-management-contract.js').CharacterManagementNamespace & import('../app/character-merge-contract.js').CharacterMergeNamespace;
...
/** I120 preview→Gate→apply/recover surface; Client owns only transient guidance state. */
