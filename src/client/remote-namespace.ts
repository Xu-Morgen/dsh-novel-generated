...
export type WorkspaceNamespace = NamespaceOf<typeof workspaceRemoteContribution> & import('../app/outline-description-contract.js').OutlineDescriptionNamespace & import('../app/draft-card-progress-contract.js').DraftCardProgressNamespace & import('../app/chapter-finalization-contract.js').ChapterFinalizationNamespace;
