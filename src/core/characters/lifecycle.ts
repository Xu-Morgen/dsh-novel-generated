...
export const characterLifecycleRecordSchema = z.object({ characterId: entityIdSchema, status: characterLifecycleStatusSchema, revision: z.number().int().nonnegative(), operationId: entityIdSchema.optional(), completedMergeIds:z.array(entityIdSchema).optional() }).strict();
