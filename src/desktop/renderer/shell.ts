...
export function createDesktopShellUi(state: WorkbenchState, actions: WorkbenchActions, workflow: DesktopProjectWorkflow, controllers?: DesktopShellControllers): WorkbenchUi {
  ...
  return {
    ...
    prepareRuleStyleRegeneration: () => controllers?.importInterpretation.prepareRuleStyleRegeneration() ?? NOOP(),
    confirmRuleStyleRegeneration: () => controllers?.importInterpretation.confirmRuleStyleRegeneration() ?? NOOP(),
    rejectRuleStyleRegeneration: () => controllers?.importInterpretation.rejectRuleStyleRegeneration() ?? NOOP(),
