...
export const CLIENT_CORE_WHITELIST: readonly string[] = [
  ...
  'src/core/schema/import-interpretation.ts',
  'src/core/schema/import-interpretation-session.ts',
  'src/core/schema/import-interpretation-analysis.ts',
  'src/core/schema/rule-style-import-initialization.ts',
  ...
  'src/core/schema/onboarding-binding.ts',
  'src/core/schema/onboarding-analysis.ts',
  'src/core/schema/onboarding-adjudication.ts',
  'src/core/schema/outline-progress.ts',
  'src/core/schema/outline.ts',
  'src/core/schema/outline-generation-scope.ts',
  'src/core/schema/outline-detail-generation.ts',
  'src/core/schema/finalization.ts',
