...
// 契约（层/视图锚点 + B5/细纲/C1 编辑 Remote），目的不变（Host-only + 边界负扫）。
for (const required of ['data-novel-layer', 'data-novel-view', 'outlineSave', 'relationshipSave', 'sceneRead', 'chapterRead']) {
