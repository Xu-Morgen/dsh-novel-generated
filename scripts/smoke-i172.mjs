...
if (lock.descriptorIds.length !== 226 || (methodIdsSource.match(/novel-creation-tool\//g) ?? []).length !== 226) throw new Error('I172 preload allowlist is not derived from the canonical desktop registry');
