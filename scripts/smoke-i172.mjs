...
if (lock.descriptorIds.length !== 234 || (methodIdsSource.match(/novel-creation-tool\//g) ?? []).length !== 234) throw new Error('I172 preload allowlist is not derived from the canonical desktop registry');
