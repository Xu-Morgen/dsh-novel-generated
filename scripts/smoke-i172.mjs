...
if (lock.descriptorIds.length !== 232 || (methodIdsSource.match(/novel-creation-tool\//g) ?? []).length !== 232) throw new Error('I172 preload allowlist is not derived from the canonical desktop registry');
