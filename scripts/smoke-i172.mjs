...
if (lock.descriptorIds.length !== 214 || (methodIdsSource.match(/novel-creation-tool\//g) ?? []).length !== 214) throw new Error('I172 preload allowlist is not derived from all 214 methods');
