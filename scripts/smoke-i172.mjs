...
if (lock.descriptorIds.length !== 229 || (methodIdsSource.match(/novel-creation-tool\//g) ?? []).length !== 229) throw new Error('I172 preload allowlist is not derived from the canonical desktop registry');
