...
if (lock.descriptorIds.length !== 236 || (methodIdsSource.match(/novel-creation-tool\//g) ?? []).length !== 236) throw new Error('I172 preload allowlist is not derived from the canonical desktop registry');
