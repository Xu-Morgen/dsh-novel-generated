...
for (const token of ['SOURCE_ROLE_HELP_LINES', 'PARAGRAPH_ROLE_HELP_LINES', 'PARAGRAPH_DECISION_HELP_LINES', "role: 'tooltip'", "'aria-describedby': help.id"]) {
...
for (const token of ['source-role', 'paragraph-source-type', 'paragraph-decision', '实际改选来源类型时自动记录']) {
...
const artifact = {
  ...
  guarantees: [
    'three-current-context-help-buttons', 'mouse-hover-tooltip', 'keyboard-focus-tooltip',
    'native-title-fallback', 'aria-describedby-role-tooltip-link', 'detailed-canonical-option-meanings',
    'source-chunk-not-word-paragraph-disclosure', 'i162-retires-misleading-merge-classification-action',
  ],
...
process.stdout.write('I154 smoke: source-role, source-fragment, and decision hover/focus help passed with I162 supersession\n');
